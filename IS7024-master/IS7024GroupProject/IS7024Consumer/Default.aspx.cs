...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        HttpWebRequest request = CreateWebRequest(@"https://maps.googleapis.com/maps/api/place/autocomplete/xml?key=AIzaSyCe3UL52kqI-5B9-QAq1ab72nJjqCeKW2s&input=" + Address);
        string AutoComplete = "";
        using (WebResponse response = request.GetResponse())
        {
            using (StreamReader rd = new StreamReader(response.GetResponseStream()))
    ...
    {
        HttpWebRequest request = CreateWebRequest(@"https://maps.googleapis.com/maps/api/place/details/xml?key=AIzaSyCe3UL52kqI-5B9-QAq1ab72nJjqCeKW2s&placeid=" + PlaceID);
        string PlaceDetails = "";
        using (WebResponse response = request.GetResponse())
        {
            using (StreamReader rd = new StreamReader(response.GetResponseStream()))
