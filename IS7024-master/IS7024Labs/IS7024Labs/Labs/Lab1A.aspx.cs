...
namespace IS7024Labs
{
    public partial class Lab1A : System.Web.UI.Page
    {
        ...
        {
            HttpWebRequest request = CreateWebRequest(@"https://maps.googleapis.com/maps/api/place/autocomplete/xml?key=AIzaSyBJs3euHjvXV3_oTlDRbRyhFsq9NcCzoxo&input=" + Place);
