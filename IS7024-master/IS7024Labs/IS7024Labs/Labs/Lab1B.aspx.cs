...
namespace IS7024Labs.Labs
{
    public partial class Lab1B : System.Web.UI.Page
    {
        ...
        {
            HttpWebRequest request = CreateWebRequest(@"https://maps.googleapis.com/maps/api/place/details/xml?key=AIzaSyBJs3euHjvXV3_oTlDRbRyhFsq9NcCzoxo&placeid=" + Place);
